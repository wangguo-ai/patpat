...
| 脚本 | 归属 | 功能 |
|------|------|------|
| `D:\报销工作台\03_脚本\xiaowang_agent.py` | 小王 | 采购员 Agent 主入口，目前是骨架 |
| `D:\app\自动化流程\版料采购单生成三表.py` | 小王 | 生成版料采购单三表、待发供应商信息、待补联系人 |
...
- 当前状态：数据底座和小李报销链路较完整；小王采购页面动作、小吴齐套出库动作、阿文统一调度仍需开发。
